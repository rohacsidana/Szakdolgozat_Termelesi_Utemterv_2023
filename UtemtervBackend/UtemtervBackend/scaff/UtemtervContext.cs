...
public partial class UtemtervContext : DbContext
{
    ...
    public virtual DbSet<KFTermekek> KFTermekeks { get; set; }
    ...
    public virtual DbSet<NincsSzerkezete> NincsSzerkezetes { get; set; }
    ...
    public virtual DbSet<SzerkezetesAnyagok> SzerkezetesAnyagoks { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.ChgLine, e.ChgFrom, e.ChgTo }).HasName("PK__CHG_MSTR__5E79CE457A4ECACD");
            ...
            entity.HasOne(d => d.ChgFromNavigation).WithMany(p => p.ChgMstrChgFromNavigations)
                ...
                .HasConstraintName("FK__CHG_MSTR__chg_fr__5441852A");

            entity.HasOne(d => d.ChgLineNavigation).WithMany(p => p.ChgMstrs)
                .HasForeignKey(d => d.ChgLine)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CHG_MSTR__chg_li__5535A963");

            entity.HasOne(d => d.ChgToNavigation).WithMany(p => p.ChgMstrChgToNavigations)
                .HasForeignKey(d => d.ChgTo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__CHG_MSTR__chg_to__5629CD9C");
        });

        modelBuilder.Entity<Dictionary>(entity =>
        {
            entity.HasKey(e => e.Value).HasName("PK__DICTIONA__40BBEA3B0AF0F581");
        ...
        modelBuilder.Entity<KFTermekek>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("k_f_termekek");
        ...
        {
            entity.HasKey(e => e.LnLine).HasName("PK__LN_MSTR__BDECFD60C2C0967C");
        ...
        {
            entity.HasKey(e => new { e.LndLine, e.LndPart }).HasName("PK__LND_DET__92C8E7667D60B3B8");
        ...
        modelBuilder.Entity<NincsSzerkezete>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("nincsSzerkezete");
        ...
        {
            entity.HasKey(e => new { e.PsPar, e.PsComp }).HasName("PK__PS_MSTR__E959B42631C1BF96");

            entity.ToTable("PS_MSTR", tb => tb.HasTrigger("SzerkFelv"));
            ...
            entity.HasOne(d => d.PsCompNavigation).WithMany(p => p.PsMstrPsCompNavigations)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PS_MSTR__ps_comp__5BE2A6F2");

            entity.HasOne(d => d.PsParNavigation).WithMany(p => p.PsMstrPsParNavigations)
                .HasForeignKey(d => d.PsPar)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__PS_MSTR__ps_par__5CD6CB2B");
        });

        modelBuilder.Entity<PtMstr>(entity =>
        {
            entity.HasKey(e => e.PtPart).HasName("PK__PT_MSTR__1C5FB9578FD525C3");
        ...
        modelBuilder.Entity<SzerkezetesAnyagok>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("szerkezetesAnyagok");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__USER__B9BE370F318FB8D9");

            entity.ToTable("USER");

            entity.HasIndex(e => e.Email, "UQ__USER__AB6E61647355A235").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.XwoYear, e.XwoWeek, e.XwoLot, e.XwoVersion }).HasName("PK__XWO_HIST__E9FB120C78503FFB");
            ...
            entity.HasOne(d => d.XwoLotNavigation).WithMany(p => p.XwoHists)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__XWO_HIST__xwo_lo__656C112C");
        });
